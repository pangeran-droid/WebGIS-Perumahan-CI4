...
<div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <div class="image">
        ...
        <div class="info">
            <a href="<?= base_url('Admin') ?>" class="d-block">
                Hello, <?= esc(session()->get('user_username') ?? 'Guest') ?> 👋
            </a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item <?= $menu == 'penerima' || $menu == 'keterangan' ? 'menu-open' : '' ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?= base_url('Penerima') ?>" class="nav-link <?= $menu == 'penerima' ? 'active' : '' ?>">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; <?= date('Y') ?> <a href="<?= base_url('Admin') ?>">WEB GIS BANTUAN PERUMAHAN</a></a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
